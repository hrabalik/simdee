...
namespace sd {
    ...
    struct sseb : sse_base<sseb> {
        ...
        SIMDEE_INL mask_t mask() const { return mask_t(dirty::as_u(_mm_movemask_ps(mm))); }
    ...
    struct sseu : sse_base<sseu> {
        ...
        SIMDEE_INL element_t first_element() const { return dirty::as_u(_mm_cvtss_f32(mm)); }
...
#   endif
    ...
    struct sses : sse_base<sses> {
        ...
        SIMDEE_INL element_t first_element() const { return dirty::as_s(_mm_cvtss_f32(mm)); }
