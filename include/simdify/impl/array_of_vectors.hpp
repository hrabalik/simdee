...
namespace simd {
    ...
    struct array_of_vectors_impl<Simd_t, detail::group<Names...>, sequence<I...>> {
    ...
    using array_of_vectors = array_of_vectors_impl<Simd_t, detail::group<Names...>, make_sequence_t<0, detail::group<Names...>::size>>;
