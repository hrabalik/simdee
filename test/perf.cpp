...
TEST_CASE("bench_ray_box", "[!hide][perf]") {
    ...
    using vec8 = std::vector<RayBoxData8, sd::detail::aligned_allocator<RayBoxData8, sizeof(__m256)>>;
    using vec1 = std::vector<RayBoxData1>;
    using vec8S = std::vector<RayBoxData8S, sd::detail::aligned_allocator<RayBoxData8, sizeof(__m256)>>;
